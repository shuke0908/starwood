<script lang="ts">
    ...
    let { isOpen = $bindable(false), title, children, width = "500px" } = $props();
...
{#if isOpen}
    ...
    >
        <header class="p-8 border-b border-toss-grey-50 flex justify-between items-center bg-white sticky top-0 z-10">
            <div>
